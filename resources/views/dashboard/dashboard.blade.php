...
<div class="" id="content">
    ...
    <section data-section-id="1" data-share="" data-category="dashboard-navigations" data-component-id="7ebd38e1_01_awz"
        class="overflow-hidden min-h-full" data-container="1">
        ...
        <div
            ...
            <div class="relative bg-coolGray-900">
                ...
                <div class="mt-28">
                    <p class="px-8 mb-2 text-xs font-medium text-coolGray-500 uppercase" data-config-id="auto-txt-1-1">
                        Main menu</p>
                    <ul class="px-4 mb-8">
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                href="#">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-2-1">
                                        Dashboard</p>
                                </div>
                        ...
                        <li>
                            <a class="p-3 pl-11 flex items-center justify-between" href="#">
                                <div class="flex items-center">
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-3-1">
                                        Overview</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="p-3 pl-11 flex items-center justify-between" href="#">
                                <div class="flex items-center">
                                    <p class="text-coolGray-500 font-medium text-base" data-config-id="auto-txt-5-1">
                                        Budget</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                ...
                                <div class="flex items-center">
                                    <svg class="mr-2" width="24" height="24" viewbox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-4-1">
                                        <path
                        ...
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-7-1">
                                        Tasks</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-8-1">
                                        Products</p>
                                </div>
                            </a>
                        </li>
                    ...
                    <p class="px-8 mb-2 text-xs font-medium text-coolGray-500 uppercase"
                        data-config-id="auto-txt-9-1">Workspace</p>
                    <ul class="px-4 pb-8">
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                href="#">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-10-1">
                                        Community</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-11-1">
                                        Calendar</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-12-1">
                                        Pages</p>
                                </div>
                                <svg width="12" height="8" viewbox="0 0 12 8" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-10-1">
                                    <path
                                        d="M11 1.17C10.8126 0.983753 10.5592 0.879211 10.295 0.879211C10.0308 0.879211 9.77737 0.983753 9.59001 1.17L6.00001 4.71L2.46001 1.17C2.27265 0.983753 2.0192 0.879211 1.75501 0.879211C1.49082 0.879211 1.23737 0.983753 1.05001 1.17C0.956281 1.26297 0.881887 1.37357 0.831118 1.49543C0.780349 1.61729 0.754211 1.74799 0.754211 1.88C0.754211 2.01202 0.780349 2.14272 0.831118 2.26458C0.881887 2.38644 0.956281 2.49704 1.05001 2.59L5.29001 6.83C5.38297 6.92373 5.49357 6.99813 5.61543 7.04889C5.73729 7.09966 5.868 7.1258 6.00001 7.1258C6.13202 7.1258 6.26273 7.09966 6.38459 7.04889C6.50645 6.99813 6.61705 6.92373 6.71001 6.83L11 2.59C11.0937 2.49704 11.1681 2.38644 11.2189 2.26458C11.2697 2.14272 11.2958 2.01202 11.2958 1.88C11.2958 1.74799 11.2697 1.61729 11.2189 1.49543C11.1681 1.37357 11.0937 1.26297 11 1.17Z"
                                        fill="#8896AB"></path>
                                </svg>
                        ...
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-white font-medium text-base" data-config-id="auto-txt-13-1">
                                        Analytics</p>
                                </div>
                            </a>
                        </li>
            ...
            <div class="relative bg-coolGray-900">
                <p class="px-8 mb-2 text-xs font-medium text-coolGray-500 uppercase" data-config-id="auto-txt-14-1">
                    Settings</p>
                <ul class="px-4 pb-28">
                    <li>
                        <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                            ...
                            <div class="flex items-center">
                                <svg class="mr-2" width="24" height="24" viewbox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-12-1">
                                    <path
                                ...
                                <p class="text-white font-medium text-base" data-config-id="auto-txt-15-1">
                                    Accounts</p>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="p-3 py-4 flex items-center justify-between text-coolGray-600 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                            ...
                            <div class="flex items-center">
                                <svg class="mr-2" width="24" height="24" viewbox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-13-1">
                                    <path
                                ...
                                <p class="text-white font-medium text-base" data-config-id="auto-txt-16-1">
                                    Settings</p>
                            </div>
                        </a>
                    </li>
                ...
                <div
                    ...
                    <div class="w-auto">
                        <div class="flex flex-wrap -mx-2">
                            ...
                            <div class="w-auto p-2">
                                <h2 class="text-sm font-semibold text-white" data-config-id="auto-txt-17-1">John
                                    Doe</h2>
                                <p class="text-sm font-medium text-coolGray-500" data-config-id="auto-txt-18-1"><a
                                        href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="02686d6a6c666d6742646e677a2c616d">[email&#160;protected]</a>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="xl:ml-80" data-bucket="1">
            <x-dashboard.page_header title="Dashboard"
                description="Texto opcional descrevendo tudo que você vai ver aqui..." />

            <section data-section-id="3" data-share="" data-category="dashboard-cards"
                data-component-id="729b7ae5_01_awz" class="bg-coolGray-50 py-4">
                    ...
                    <div class="flex flex-wrap -m-3">
                        <div class="w-full md:w-1/2 xl:w-1/4 p-3">
                            <div class="bg-white border border-coolGray-100 shadow-dashboard rounded-md">
                                <div
                                    class="flex flex-col justify-center items-center px-4 pt-8 pb-6 border-b border-coolGray-100">
                                    <img class="mb-4" src="flex-ui-assets/images/dashboard/cards/avatar.png"
                                        alt="" data-config-id="auto-img-1-1">
                                    <h2 class="text-sm font-medium text-coolGray-900" data-config-id="auto-txt-1-1">
                                        John Doe</h2>
                                    <h3 class="mb-3 text-xs font-medium text-coolGray-400"
                                        data-config-id="auto-txt-2-1"><a href="/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="610b0e090f050e0421070d04194f020e">[email&#160;protected]</a>
                                    </h3>
                                    <button
                                        class="flex items-center px-4 py-2 font-medium text-sm text-white bg-green-500 hover:bg-green-600 rounded-md">
                                        ...
                                        <p data-config-id="auto-txt-3-1">Message</p>
                                    </button>
                                </div>
                                <div class="flex flex-wrap pt-4 pb-6 -m-2">
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-4-1">24</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-5-1">Posts</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-6-1">420</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-7-1">Following</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-8-1">2.7k</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-9-1">Followers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="w-full md:w-1/2 xl:w-1/4 p-3">
                            <div class="bg-white border border-coolGray-100 shadow-dashboard rounded-md">
                                <div
                                    ...
                                    <h2 class="text-sm font-medium text-coolGray-900" data-config-id="auto-txt-10-1">
                                        John Doe</h2>
                                    <h3 class="mb-3 text-xs font-medium text-coolGray-400"
                                        data-config-id="auto-txt-11-1"><a href="/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="5c363334323833391c3a303924723f33">[email&#160;protected]</a>
                                    </h3>
                                    <button
                                        class="flex items-center px-4 py-2 font-medium text-sm text-white bg-green-500 hover:bg-green-600 rounded-md">
                                        <svg class="mr-2" width="20" height="20" viewbox="0 0 20 20"
                                        ...
                                        <p data-config-id="auto-txt-12-1">Message</p>
                                    </button>
                                </div>
                                <div class="flex flex-wrap pt-4 pb-6 -m-2">
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-13-1">24</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-14-1">Posts</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-15-1">420</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-16-1">Following</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-17-1">2.7k</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-18-1">Followers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="w-full md:w-1/2 xl:w-1/4 p-3">
                            <div class="bg-white border border-coolGray-100 shadow-dashboard rounded-md">
                                <div
                                    ...
                                    <h2 class="text-sm font-medium text-coolGray-900" data-config-id="auto-txt-19-1">
                                        John Doe</h2>
                                    <h3 class="mb-3 text-xs font-medium text-coolGray-400"
                                        data-config-id="auto-txt-20-1"><a href="/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="771d181f1913181237111b120f591418">[email&#160;protected]</a>
                                    </h3>
                                    <button
                                        class="flex items-center px-4 py-2 font-medium text-sm text-white bg-green-500 hover:bg-green-600 rounded-md">
                                        <svg class="mr-2" width="20" height="20" viewbox="0 0 20 20"
                                        ...
                                        <p data-config-id="auto-txt-21-1">Message</p>
                                    </button>
                                </div>
                                <div class="flex flex-wrap pt-4 pb-6 -m-2">
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-22-1">24</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-23-1">Posts</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-24-1">420</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-25-1">Following</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-26-1">2.7k</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-27-1">Followers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="w-full md:w-1/2 xl:w-1/4 p-3">
                            <div class="bg-white border border-coolGray-100 shadow-dashboard rounded-md">
                                <div
                                    ...
                                    <h2 class="text-sm font-medium text-coolGray-900" data-config-id="auto-txt-28-1">
                                        John Doe</h2>
                                    <h3 class="mb-3 text-xs font-medium text-coolGray-400"
                                        data-config-id="auto-txt-29-1"><a href="/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="bfd5d0d7d1dbd0daffd9d3dac791dcd0">[email&#160;protected]</a>
                                    </h3>
                                    <button
                                        class="flex items-center px-4 py-2 font-medium text-sm text-white bg-green-500 hover:bg-green-600 rounded-md">
                                        <svg class="mr-2" width="20" height="20" viewbox="0 0 20 20"
                                        ...
                                        <p data-config-id="auto-txt-30-1">Message</p>
                                    </button>
                                </div>
                                <div class="flex flex-wrap pt-4 pb-6 -m-2">
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-31-1">24</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-32-1">Posts</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-33-1">420</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-34-1">Following</p>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 p-2">
                                        <div class="text-center">
                                            <p class="mb-1 text-xs text-coolGray-900 font-semibold"
                                                data-config-id="auto-txt-35-1">2.7k</p>
                                            <p class="text-xs text-coolGray-400 font-medium"
                                                data-config-id="auto-txt-36-1">Followers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
