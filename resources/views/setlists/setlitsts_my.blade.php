...
@section('header')
    ...
    <x-navbar.main title="Repertórios" description="Descrição qualquer" buttonLabel="Repertório" />
@endsection

@section('main')
    <div class="flex flex-col items-end mb-4">
        <a href="{{ route('setlist_create') }}"><button type="button"
                ...
                <spán class="ml-2">Adicionar Repertório</span>
            </button></a>
    </div>
