            ...
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:flex-1 p-3">
                    <div
                        ...
                        <p class="px-4 text-base text-coolGray-500 font-normal">{{ Request::root()}}/music/</p>
                        <input class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none border-l"
                            type="text" placeholder="hey_jude">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full md:w-9/12">
            <div class="flex flex-wrap -m-3">
                <div class="w-full md:w-1/3 p-3">
                    ...
                    <p class="text-xs text-coolGray-500 font-medium">Insira a cifra com [D] onde quer que seja exibida.</p>
                </div>
                <div class="w-full md:flex-1 p-3">
                    <textarea placeholder="[A]Hey jude, [B]don't let"
