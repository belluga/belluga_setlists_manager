    ...
    <div class="grid h-screen place-items-center">
        <div
            ...
            <form class="flex flex-col">
                ...
                <button type="submit"
                    class="w-full text-[#FFFFFF] bg-[#4F46E5] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Entrar</button>
                <div class="text-sm font-light text-[#6B7280] text-center">Já tem uma conta? <a href="{{ route('login') }}"
                        class="font-medium text-[#4F46E5] hover:underline">Faça login</a>
